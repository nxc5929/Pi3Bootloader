...
#ifdef PI2
    #define BOOT_RPI_PERI_BASE_ADDR 0x3F200000UL
    #define BOOT_OK_LED_SELECT_FUNC 0x00200000
    #define BOOT_OK_LED_SELECT_REG GPFSEL4
    #define BOOT_OK_LED_SET_REG GPSET1
    #define BOOT_OK_LED_CLR_REG GPCLR1
    #define BOOT_OK_LED_SET_MASK (1 << 15) // Pi 2 and newer, this is GPI 47.
#else
    #define BOOT_RPI_PERI_BASE_ADDR 0x20200000UL
    #define BOOT_OK_LED_SELECT_FUNC 0x00040000
    #define BOOT_OK_LED_SELECT_REG GPFSEL1
    #define BOOT_OK_LED_SET_REG GPSET0
    #define BOOT_OK_LED_CLR_REG GPCLR0
    #define BOOT_OK_LED_SET_MASK (1 << 16)
#endif

static volatile uintptr_t *boot_gpio = (uintptr_t*) BOOT_RPI_PERI_BASE_ADDR;
...
#define BOOT_GPFSEL0 0
#define BOOT_GPFSEL1 1
#define BOOT_GPFSEL2 2
#define BOOT_GPFSEL3 3
#define BOOT_GPFSEL4 4
#define BOOT_GPFSEL5 5

// These set of registers in the PI are the output registers for setting the GPIOS to HIGH.
// | Register Name | Bit Mapping                                                                                           |
// | BOOT_GPSET0        | 31-0 mapps to GPIO31 to GPIO0.  Set the bit to 1 to turn the GPIO HIGH.  Setting to 0 has no effect.  |
// | BOOT_GPSET1        | 31-22 is don't care. 21-0 are mapped to GPIO53 to GPIO32.  Set bit to 1 to turn HIGH, 0 has no effect |
//
// Register Addresses:
#define BOOT_GPSET0 7
#define BOOT_GPSET1 8
...
//
// Register Addresses:
#define BOOT_GPCLR0 10
#define BOOT_GPCLR1 11
...
//
// Register Addresses:
#define BOOT_GPLVL0 13
#define BOOT_GPLVL1 14
...
//
// Register Addresses:
#define BOOT_GPPUDCLK0 38
#define BOOT_GPPUDCLK1 39
