...
#define BOOT_UART0_BASE_ADDR (BOOT_RPI_PERI_BASE_ADDR + 0x1000)

static volatile uint32_t *boot_uart = (uint32_t*)BOOT_UART0_BASE_ADDR;
...
extern size_t boot_get_string(char* buffer, size_t buffer_size);
...
extern void boot_put_string(const char* str);
